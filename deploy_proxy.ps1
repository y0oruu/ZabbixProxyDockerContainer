...
wsl.exe -d Ubuntu -u zabbix cp /mnt/c/proxyzabbix/d-compose/docker-compose.yml ~/docker/docker-compose.yml // modify path according to your path
wsl.exe -d Ubuntu -u zabbix docker compose -f ~/docker/docker-compose.yml up -d // modify path according to your path
